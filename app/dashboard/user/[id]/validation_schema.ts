...
export const UserDataSchema: ZodType = z.object({
  name: z
    .string()
  ...
  phone_number: z
    .string()
    .regex(/^\+?\d{9,15}$/, "Numer telefonu musi mieć od 9 do 15 cyfr i może zaczynać się od +!"),
  ...
  house_number: z
    .string()
    .regex(/^\d+[a-zA-Z]?$/, "Numer domu musi być liczbą, opcjonalnie z literą!"),
...
export const UserPaymentSchema: ZodType = z.object({
  card_first_name: z
    .string()
    .min(2, "Imię musi mieć co najmniej 2 znaki!")
    .max(30, "Imię może mieć maksymalnie 30 znaków!")
